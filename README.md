...
- **Reasoning:** every reply carries Claude's thinking summary. It streams open while Claude thinks and folds into a collapsed "Thinking" row once the answer starts. (Claude Code withholds the text in headless mode unless asked; Open asks with `--settings '{"showThinkingSummaries":true}'`.)
